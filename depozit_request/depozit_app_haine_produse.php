...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT * from depozit_app_haine.Produse";
            ...
            if (isset($_GET['depozit_app_haine_produse'])) {
            ...
            echo "<hr>";
            echo "<div id='client-count'>Sunt " . $count . " produse in depozit.</div>";
        ?>
      </div>
</body>
</html>