...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT c.ID_comanda, c.Data_comanda, c.Adresa_livrare, cl.Nume AS Nume_client, c.Status_comanda
                FROM depozit_app_haine.Comenzi c
                JOIN depozit_app_haine.Clienti cl ON c.ID_client = cl.ID_client";
